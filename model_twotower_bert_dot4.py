...
class Plain_bert(nn.Module):#
    def __init__(self,args):
        ...
        self.news_encoder=TransformerSentenceEncoder(
                padding_idx=1,
                vocab_size=32769,
                num_encoder_layers=12,
                embedding_dim=768,
    ...
    def forward(self, his_id , candidate_id , label,mode='train'):#
        ...
        can_features,_=self.news_encoder(candidate_id)
        ...
        can_features = self.news_dense(can_features)
        can_features = self.news_layer_norm(can_features)
